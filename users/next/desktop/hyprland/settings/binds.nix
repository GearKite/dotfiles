{ config, ... }:
{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      # Actions
      "$mainMod, RETURN, exec, ${config.modules.executable.terminal}" # Open Alactritty
      "$mainMod, Q, killactive" # Close current window
      "$mainMod, M, exit" # Exit Hyprland
      "$mainMod, E, exec, ${config.modules.executable.filemanager}" # Opens the filemanager
      ...
      "$mainMod, B, exec, ${config.modules.executable.browser}" # Opens the browser
